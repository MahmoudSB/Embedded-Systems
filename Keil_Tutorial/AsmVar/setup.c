...
#include<stdint.h>
#define WDWORD(x, y) x+y

 void Setup (void) {

// <h> External Bus Interface (EBI)

//   <e1.13> Chip Select 0 (CSR0)
...
//   </e>
  WDWORD(0xFFE00000, 0x010024A9);   // EBI_CSR0: Flash
...
//                 <i> Number of Cycles Added after the Transfer
//   </e>
  WDWORD(0xFFE00004, 0x040034A5);   // EBI_CSR1: RAM

//   <q1.4>        DRP: Data Read Protocol
//                      <0=> Standard Read
//                      <1=> Early Read
  WDWORD(0xFFE00024, 0x00000010);   // EBI_MCR:  Data Read Protocol

  WDWORD(0xFFE00020, 0x00000001);   // EBI_RCR:  Remap Command
